		...
		<section className="notre-creche container-max">
			...
			<div className="grid-notrekita grid gap-4 mb-4 md:grid-cols-2 sm:grid-cols-1 items-center ">
				<div className="texto-kita text-l leading-relaxed text-justify">
					...
					<div className="logo-member flex gap-10 justify-center p-10"><img src="./logo-kibesuisse.png" alt="Membre Kibessuisse"  className='w-[auto] h-[150px] sm:h-[100px]' /><img src="./SBFI_SEFRI_Vignette_140mm_FR.png" alt="vignette SBFI" className='max-w-[150px] h-[150px] sm:h-[100px]' /></div>
				</div>
				<SliderInfinito
					photo={imagesKita}
					autoPlay={true}
